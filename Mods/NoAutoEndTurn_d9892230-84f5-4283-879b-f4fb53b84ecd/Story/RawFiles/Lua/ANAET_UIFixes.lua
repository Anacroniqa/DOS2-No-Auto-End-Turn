            ...
            if event.UI:GetTypeId() == Ext.UI.TypeID.textDisplay and event.Function == "addText" then
                ...
                local StrXAP = Ext.L10N.GetTranslatedString("h984df648geba3g4eaagb035g2088d0e58f72")
                    if Paralized and string.find(Text, StrMovementSpeedIs0) then
                        local StrNotEnoughAP = Ext.L10N.GetTranslatedString("h478017a5gdbc6g44ffgb28dga893e733370b")
                        Text = Text:gsub(StrMovementSpeedIs0, StrNotEnoughAP, 1) --When you are out of AP and movement, this replaces the text "Movement speed is 0." in "Can't move: Movement speed is 0." with "Not enough AP"
                    end
...
--Not enough AP: h478017a5gdbc6g44ffgb28dga893e733370b
